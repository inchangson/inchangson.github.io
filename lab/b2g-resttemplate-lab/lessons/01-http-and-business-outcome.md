...
2026-09-07 Docker 실행에서 세 테스트가 모두 통과했다. 실행 JVM은 Temurin `1.8.0_452` ARM64이고, 생성된 `DemoApplication.class`의 major version은 52였다. Spring Boot `1.5.12.RELEASE`가 관리하는 Spring Framework `4.3.16.RELEASE`, 명시한 HttpClient `4.5.5` 조합으로 실행했다.
