...
> 로컬 실험에 합성 YAML 20개와 최대 38개의 Python HTTP worker를 사용했습니다. 실제 업무 시스템의 규모는 공개하지 않습니다.

fixture에는 application당 route 20개, 총 400개의 route 모양 설정을 넣었다. 이는 합성 실험 조건이며 실제 운영 route 수를 뜻하지 않는다.
