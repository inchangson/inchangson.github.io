...
description: "3개 OEM 사이트의 배포 대상을 VM 한 대로 제한하고 입력 오류와 원격 실행 실패를 드러내도록 변경했다."
pubDate: 2026-09-07
draft: true
category: ops
subcategory: cicd
...
3개 OEM 내비게이션 업데이트 사이트를 운영하며 CI/CD 구축과 배포 문제 해결을 담당했다. 각 사이트는 복수의 WAS VM을 사용하고 애플리케이션, 프로필, 배포 경로가 달랐다. 운영 CD는 한 번의 실행이 선택된 VM 한 대만 변경하도록 분리했다.
