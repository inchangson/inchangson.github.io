...
원본 루트: `/Users/son-inchang/Work/mobility/backup/GatewayPoC/sp-gw-mgmt`.

- `src/main/java/com/avis/sp_gw_mgmt/StateAwareNativeEnvironmentRepository.java`: `getFileInfo`, `buildCacheKey`, `findOne`, `cleanupOldCacheEntries`
